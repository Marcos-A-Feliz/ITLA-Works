...
do
{
    ...
    try
    {
        ...
        switch (typeOption)
        {
            case 1: // Add Contact
                {
                    AddContact(ids, names, lastnames, addresses, telephones, emails, favorites);
                } break;
            case 2: // View Contacts
                {
                    ViewContacts(ids, names, lastnames, addresses, telephones, emails, favorites);
                } break;
            case 3:// Search Contacts
                {
                    SearchContact(ids, names, lastnames, addresses, telephones, emails, favorites);
                } break;
            case 4: // Edit Contact
                {
                    EditContact(ids, names, lastnames, addresses, telephones, emails, favorites);
                } break;
            case 5: // Delete Contact
                {
                    DeleteContact(ids, names, lastnames, addresses, telephones, emails, favorites);
                } break;
            case 6: // Exit
                {
                    running = false;
...
static void AddContact(List<int> ids, Dictionary<int, string> names, Dictionary<int, string> lastnames, Dictionary<int, string> addresses, Dictionary<int, string> telephones, Dictionary<int, string> emails, Dictionary<int, bool> favorites)
{
    string name;
    while (true)
    {
...
static void ViewContacts(List<int> ids, Dictionary<int, string> names, Dictionary<int, string> lastnames, Dictionary<int, string> addresses, Dictionary<int, string> telephones, Dictionary<int, string> emails, Dictionary<int, bool> favorites)
{
    if (ids.Count == 0)
    {
...
static void SearchContact(List<int> ids, Dictionary<int, string> names, Dictionary<int, string> lastnames, Dictionary<int, string> addresses, Dictionary<int, string> telephones, Dictionary<int, string> emails, Dictionary<int, bool> favorites)
{
    if (ids.Count == 0)
    {
...
static void EditContact(List<int> ids, Dictionary<int, string> names, Dictionary<int, string> lastnames, Dictionary<int, string> addresses, Dictionary<int, string> telephones, Dictionary<int, string> emails, Dictionary<int, bool> favorites)
{
    if (ids.Count == 0)
    {
...
static void DeleteContact(List<int> ids, Dictionary<int, string> names, Dictionary<int, string> lastnames, Dictionary<int, string> addresses, Dictionary<int, string> telephones, Dictionary<int, string> emails, Dictionary<int, bool> favorites)
{
    if (ids.Count == 0)
    {
